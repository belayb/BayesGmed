...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_NY_NM_single");
    reader.add_event(95, 93, "end", "model_NY_NM_single");
    return reader;
}
#include <stan_meta_header.hpp>
class model_NY_NM_single
  : public stan::model::model_base_crtp<model_NY_NM_single> {
private:
        int N;
        int P;
        matrix_d X;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("location_m", "(P + 2)", (P + 2));
            context__.validate_dims("data initialization", "location_m", "vector_d", context__.to_vec((P + 2)));
            location_m = Eigen::Matrix<double, Eigen::Dynamic, 1>((P + 2));
            vals_r__ = context__.vals_r("location_m");
            pos__ = 0;
            size_t location_m_j_1_max__ = (P + 2);
            for (size_t j_1__ = 0; j_1__ < location_m_j_1_max__; ++j_1__) {
                location_m(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 16;
            validate_non_negative_index("location_y", "(P + 1)", (P + 1));
            context__.validate_dims("data initialization", "location_y", "vector_d", context__.to_vec((P + 1)));
            location_y = Eigen::Matrix<double, Eigen::Dynamic, 1>((P + 1));
            vals_r__ = context__.vals_r("location_y");
            pos__ = 0;
            size_t location_y_j_1_max__ = (P + 1);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(multi_normal_log<propto__>(alpha, location_m, scale_m));
            current_statement_begin__ = 50;
            lp_accum__.add(multi_normal_log<propto__>(beta, location_y, scale_y));
            current_statement_begin__ = 52;
            lp_accum__.add((student_t_log(sigma_m, 3, 0, 10) - (1 * student_t_ccdf_log(0, 3, 0, 10))));
            current_statement_begin__ = 53;
            lp_accum__.add((student_t_log(sigma_y, 3, 0, 10) - (1 * student_t_ccdf_log(0, 3, 0, 10))));
            current_statement_begin__ = 56;
            lp_accum__.add(normal_log<propto__>(M, add(multiply(X, betaZ), multiply(A, betaA)), sigma_m));
            current_statement_begin__ = 57;
            lp_accum__.add(normal_log<propto__>(Y, add(add(multiply(X, alphaZ), multiply(A, alphaA)), multiply(Mv, alphaM)), sigma_y));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(M_a0, 
                            ...
                            normal_rng(multiply(get_base1(X, row_i, "X", 1), betaZ), sigma_m, base_rng__), 
                            "assigning variable M_a0");
                current_statement_begin__ = 79;
                stan::model::assign(M_a1, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            normal_rng((multiply(get_base1(X, row_i, "X", 1), betaZ) + betaA), sigma_m, base_rng__), 
                            "assigning variable M_a1");
                current_statement_begin__ = 81;
                stan::model::assign(Y_a1Ma0, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            normal_rng(((multiply(get_base1(X, row_i, "X", 1), alphaZ) + (get_base1(M_a0, n, "M_a0", 1) * alphaM)) + alphaA), sigma_y, base_rng__), 
                            "assigning variable Y_a1Ma0");
                current_statement_begin__ = 82;
                stan::model::assign(Y_a0Ma0, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            normal_rng((multiply(get_base1(X, row_i, "X", 1), alphaZ) + (get_base1(M_a0, n, "M_a0", 1) * alphaM)), sigma_y, base_rng__), 
                            "assigning variable Y_a0Ma0");
                current_statement_begin__ = 84;
                stan::model::assign(Y_a1Ma1, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            normal_rng(((multiply(get_base1(X, row_i, "X", 1), alphaZ) + (get_base1(M_a1, n, "M_a1", 1) * alphaM)) + alphaA), sigma_y, base_rng__), 
                            "assigning variable Y_a1Ma1");
                current_statement_begin__ = 85;
                stan::model::assign(Y_a0Ma1, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            normal_rng((multiply(get_base1(X, row_i, "X", 1), alphaZ) + (get_base1(M_a1, n, "M_a1", 1) * alphaM)), sigma_y, base_rng__), 
...
typedef model_NY_NM_single_namespace::model_NY_NM_single stan_model;
#ifndef USING_R
