...
#include "stanExports_NY_NM_single.h"

RCPP_MODULE(stan_fit4NY_NM_single_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_NY_NM_single")
