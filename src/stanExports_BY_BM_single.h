...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_BY_BM_single");
    reader.add_event(87, 85, "end", "model_BY_BM_single");
    return reader;
}
#include <stan_meta_header.hpp>
class model_BY_BM_single
  : public stan::model::model_base_crtp<model_BY_BM_single> {
private:
        int N;
        int P;
        matrix_d X;
...
typedef model_BY_BM_single_namespace::model_BY_BM_single stan_model;
#ifndef USING_R
