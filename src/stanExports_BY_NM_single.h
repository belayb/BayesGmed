...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_BY_NM_single");
    reader.add_event(91, 89, "end", "model_BY_NM_single");
    return reader;
}
#include <stan_meta_header.hpp>
class model_BY_NM_single
  : public stan::model::model_base_crtp<model_BY_NM_single> {
private:
        int N;
        int P;
        matrix_d X;
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(M, add(multiply(X, betaZ), multiply(A, betaA)), sigma));
            current_statement_begin__ = 53;
            lp_accum__.add(bernoulli_logit_log<propto__>(Y, add(add(multiply(X, alphaZ), multiply(A, alphaA)), multiply(Mv, alphaM))));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(M_a0, 
                            ...
                            normal_rng(multiply(get_base1(X, row_i, "X", 1), betaZ), sigma, base_rng__), 
                            "assigning variable M_a0");
                current_statement_begin__ = 75;
                stan::model::assign(M_a1, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            normal_rng((multiply(get_base1(X, row_i, "X", 1), betaZ) + betaA), sigma, base_rng__), 
                            "assigning variable M_a1");
                current_statement_begin__ = 77;
                stan::model::assign(Y_a1Ma0, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            bernoulli_logit_rng(((multiply(get_base1(X, row_i, "X", 1), alphaZ) + (get_base1(M_a0, n, "M_a0", 1) * alphaM)) + alphaA), base_rng__), 
                            "assigning variable Y_a1Ma0");
                current_statement_begin__ = 78;
                stan::model::assign(Y_a0Ma0, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            bernoulli_logit_rng((multiply(get_base1(X, row_i, "X", 1), alphaZ) + (get_base1(M_a0, n, "M_a0", 1) * alphaM)), base_rng__), 
                            "assigning variable Y_a0Ma0");
                current_statement_begin__ = 80;
                stan::model::assign(Y_a1Ma1, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            bernoulli_logit_rng(((multiply(get_base1(X, row_i, "X", 1), alphaZ) + (get_base1(M_a1, n, "M_a1", 1) * alphaM)) + alphaA), base_rng__), 
                            "assigning variable Y_a1Ma1");
                current_statement_begin__ = 81;
                stan::model::assign(Y_a0Ma1, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            bernoulli_logit_rng((multiply(get_base1(X, row_i, "X", 1), alphaZ) + (get_base1(M_a1, n, "M_a1", 1) * alphaM)), base_rng__), 
...
typedef model_BY_NM_single_namespace::model_BY_NM_single stan_model;
#ifndef USING_R
